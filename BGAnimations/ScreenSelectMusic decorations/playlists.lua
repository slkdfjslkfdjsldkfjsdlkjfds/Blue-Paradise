...
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(frameWidth + 260, frameY + offsetY - 11):zoom(0.65):halign(1)
	end,
...
r[#r + 1] = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		InitCommand = function(self)
			...
			self:settext(translated_info["Previous"]):x(45)
		end,
		DisplayAllPlaylistsMessageCommand = function(self)
			self:visible(false)
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		...
		DisplayAllPlaylistsMessageCommand = function(self)
			...
			self:x(capWideScale(250,265)):x(250)
		end,
		DisplaySinglePlaylistMessageCommand = function(self)
			self.state = "Upload"
			self:queuecommand("MaintainState")
...
r[#r + 1] = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		InitCommand = function(self)
			self:halign(0):zoom(0.25):diffuse(getMainColor("positive"))
			self:settext(translated_info["Previous"]):x(-275)
		end,
		DisplaySinglePlaylistMessageCommand = function(self)
			self:visible(false)
		end,
	...
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:x(-160):halign(0.5):zoom(0.25)
		end,
		SetCommand = function(self)
			self:settextf(
				"%s %i-%i (%i)",
