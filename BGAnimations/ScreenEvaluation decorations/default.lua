...
t[#t + 1] = Def.Sprite {
	...
	InitCommand=function(self)
		self:xy(SCREEN_CENTER_X - 210,SCREEN_CENTER_Y - 132)
	...
	local t = Def.ActorFrame {
		...
		Def.ActorFrame {
			...
			UIElements.QuadButton(1, 1) .. {
				Name = "BG",
				InitCommand = function(self)
					self:zoomto(capWideScale(get43size(280),235), 25)
			...
			Def.Quad {
				...
				InitCommand = function(self)
					self:xy(0, 0)
					self:zoomto(capWideScale(get43size(280),235), 2)
					self:halign(0)
					self:diffuse(getMainColor("highlight"))
					self:diffusealpha(0.5)
				end,
...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		Name = "CurrentTime",
		InitCommand = function(self)
			self:xy(SCREEN_RIGHT - 5, SCREEN_HEIGHT - 6):halign(1):valign(1):zoom(0.41)
	...
	LoadFont("Common Normal") .. {
		Name = "SessionTime",
		InitCommand = function(self)
			self:xy(SCREEN_CENTER_X - 55, SCREEN_HEIGHT - 6):halign(0):valign(1):zoom(0.41)
			self:diffuse(getMainColor("positive"))
