...
local t = Def.ActorFrame {
	...
	Def.Quad {
		InitCommand = function(self)
			self:xy(frameX + 270, frameY - 146):zoomto(110, 164):halign(0):valign(0):diffuse(getMainColor("tabs"))
		end
	},
	Def.Quad {
		InitCommand = function(self)
			self:xy(frameX + 270, frameY + 18):zoomto(frameWidth + 4, 50):halign(0):valign(0):diffuse(getMainColor("tabs"))
		end
	},
	Def.Quad {
		InitCommand = function(self)
			self:xy(frameX + 270, frameY - 146):zoomto(8, 214):halign(0):valign(0):diffuse(getMainColor("highlight")):diffusealpha(0.6)
		end
	},
}
...
t[#t + 1] = UIElements.TextToolTip(1, 1, "Common Large") .. {
	InitCommand = function(self)
		self:xy(290, SCREEN_BOTTOM - 226):visible(true):halign(0):zoom(0.4):maxwidth(
...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Large") .. {
		Name = "MSD",
		InitCommand = function(self)
			self:xy(frameX + 328, frameY - 62):halign(0.5):zoom(0.6):maxwidth(110 / 0.6)
		end,
		MintyFreshCommand = function(self)
			if song then
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 390, frameY - 60):halign(0):zoom(0.6, maxwidth, 125)
		end,
		MintyFreshCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 390, frameY - 30):halign(0):zoom(0.6, maxwidth, 125)
		end,
		MintyFreshCommand = function(self)
			if song and GAMESTATE:GetCurrentStyle():ColumnsPerPlayer() == 4 then
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 390, frameY):halign(0):zoom(0.6, maxwidth, 125)
		end,
		MintyFreshCommand = function(self)
			if song and GAMESTATE:GetCurrentStyle():ColumnsPerPlayer() == 4 then
	...
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX + 328, frameY + 48):zoom(0.6):halign(0.5):maxwidth(150):valign(1)
		end,
		MintyFreshCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 302, frameY + 57):zoom(0.5):halign(1)
		end,
		MintyFreshCommand = function(self)
			if song and score then
				local mirrorStr = ""
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 358, frameY + 57):zoom(0.5):halign(0.5)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameX + 310, frameY + 57):zoom(0.5):halign(0):maxwidth(140)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "Goalll",
		InitCommand = function(self)
			self:xy(capWideScale(frameX + 510,frameX + 154), frameY + 27):zoom(0.6):halign(0.5):valign(0)
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(capWideScale(frameX + 380,frameX + 205), frameY + 59):zoom(0.4):halign(0)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(capWideScale(frameX + 380,frameX + 205), frameY + 45):zoom(0.4):halign(0)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	LoadFont("Common Normal") .. {
		Name = "ClearType",
		InitCommand = function(self)
			self:xy(capWideScale(frameX + 380,frameX + 205), frameY + 30):zoom(0.6):halign(0)
		end,
		MintyFreshCommand = function(self)
			if song and score then
				self:visible(true)
	...
	Def.BPMDisplay {
		...
		Name = "BPMDisplay",
		InitCommand = function(self)
			self:xy(capWideScale(get43size(734), 400) + 62, SCREEN_BOTTOM - 110.5):halign(1):zoom(0.50):maxwidth(50)
		end,
		MintyFreshCommand = function(self)
			if song then
				self:visible(true)
	...
	LoadFont("Common Large") .. {
		...
		InitCommand = function(self)
			self:xy((capWideScale(get43size(734), 400)) + 62, SCREEN_BOTTOM - 91.5):visible(true):halign(1):zoom(
...
local function radarPairs(i)
	local o = Def.ActorFrame {
		...
		LoadFont("Common Normal") .. {
			InitCommand = function(self)
				self:xy(frameX + 283, frameY - 52 + 13 * i):zoom(0.5):halign(0):maxwidth(120)
			end,
			MintyFreshCommand = function(self)
				if song then
		...
		LoadFont("Common Normal") .. {
			InitCommand = function(self)
				self:xy(frameX + 378, frameY + -52 + 13 * i):zoom(0.5):halign(1):maxwidth(60)
			end,
...
t[#t + 1] =LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(capWideScale(get43size(729), 395) + 41, SCREEN_BOTTOM - 110.5):halign(1):zoom(0.50)
	end,
...
t[#t + 1] = UIElements.SpriteButton(1, 1, nil) .. {
	InitCommand = function(self)
		self:xy(capWideScale(get43size(504), 364) + 50, capWideScale(get43size(345), 255))
...
t[#t + 1] = Def.Sprite {
	Name = "Banner",
	InitCommand = function(self)
		self:x(275):y(50):halign(0):valign(0)
...
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(frameX + 500, frameY - 60):halign(0):zoom(0.6):maxwidth(capWideScale(54, 450) / 0.6)
	end,
	MintyFreshCommand = function(self)
...
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(frameX + 500, frameY - 30):halign(0):zoom(0.6):maxwidth(capWideScale(54, 450) / 0.6)
	end,
	MintyFreshCommand = function(self)
...
t[#t + 1] = LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy(frameX + 500, frameY):halign(0):zoom(0.6):maxwidth(capWideScale(54, 450) / 0.6)
	end,
	MintyFreshCommand = function(self)
...
t[#t + 1] = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			...
			self:xy(290, 235):zoom(0.5):halign(0)
			self:diffuse(getMainColor("positive"))
		end,
		MouseDownCommand = function(self, params)
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			self:xy(290, 218):halign(0):zoom(0.5)
...
t[#t + 1] =
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			self:xy(290, 201):zoom(0.5):halign(0):settext(translated_info["OpenSort"])
			self:diffuse(getMainColor("positive"))
		end,
		MouseDownCommand = function(self, params)
			if params.event == "DeviceButton_left mouse button" then
