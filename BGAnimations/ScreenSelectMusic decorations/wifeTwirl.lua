...
r[#r + 1] = LoadFont("Common Large") .. {
	InitCommand = function(self)
		self:xy(frameX + 250, SCREEN_BOTTOM - 145):visible(true):halign(0):zoom(0.5)
...
t[#t + 1] = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			...
			self:xy(280, 235):zoom(0.5):halign(0)
			self:diffuse(getMainColor("positive"))
		end,
		MouseDownCommand = function(self, params)
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			self:xy(280, 218):halign(0):zoom(0.5)
...
t[#t + 1] =
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			self:xy(280, 201):zoom(0.5):halign(0):settext(translated_info["OpenSort"])
			self:diffuse(getMainColor("positive"))
		end,
		MouseDownCommand = function(self, params)
			if params.event == "DeviceButton_left mouse button" then
