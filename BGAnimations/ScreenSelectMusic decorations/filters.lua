...
local f = Def.ActorFrame {
	...
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX - 265, frameY -17):zoom(0.3):halign(0)
			self:settext(translated_info["ExplainStartInput"])
		end
	},
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX - 265, frameY + 20 -17):zoom(0.3):halign(0)
			self:settext(translated_info["ExplainCancelInput"])
		end
	},
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX - 265, frameY + 40 -17):zoom(0.3):halign(0)
			self:settext(translated_info["ExplainGrey"])
		end
	},
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX - 265, frameY + 60 -17):zoom(0.3):halign(0)
			self:settext(translated_info["ExplainBounds"]):x(5)
		end
	},
	...
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			...
			self:settext(translated_info["ExplainHighest"]):x(5)
		end
	},
	LoadFont("Common Large") .. {
		InitCommand = function(self)
			self:xy(frameX, frameY + 100 -17):zoom(0.3):halign(0)
			self:settext(translated_info["ExplainHighestDifficulty"]):x(5)
		end
	},
	]]
	UIElements.TextToolTip(1, 1, "Common Large") ..{
		...
		SetCommand = function(self)
			self:settextf("%s:%5.1fx", translated_info["MaxRate"], FILTERMAN:GetMaxFilterRate()):x(200)
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Large") ..{
		...
		SetCommand = function(self)
			self:settextf("%s:%5.1fx", translated_info["MinRate"], FILTERMAN:GetMinFilterRate()):x(200)
		end,
		MaxFilterRateChangedMessageCommand = function(self)
			self:queuecommand("Set")
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Large") ..{
		...
		SetCommand = function(self)
			if FILTERMAN:GetFilterMode() then
				self:settextf("%s: %s", translated_info["Mode"], translated_info["AND"]):x(200)
			else
				self:settextf("%s: %s", translated_info["Mode"], translated_info["OR"]):x(200)
			end
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Large") ..{
		...
		SetCommand = function(self)
			...
			if FILTERMAN:GetHighestSkillsetsOnly() then
				self:settextf("%s: %s", translated, translated_info["On"]):maxwidth(frameWidth / 2 / textzoom - 50):x(200)
			else
				self:settextf("%s: %s", translated, translated_info["Off"]):maxwidth(frameWidth / 2 / textzoom - 50):x(200)
			end
			if FILTERMAN:GetFilterMode() then
	...
	LoadFont("Common Large") .. {
		...
		FilterResultsMessageCommand = function(self, msg)
			self:settextf("%s: %i/%i", translated_info["Matches"], msg.Matches, msg.Total):x(200)
		end
	},
	UIElements.TextToolTip(1, 1, "Common Large") .. {
		BeginCommand = function(self)
...
f[#f + 1] = UIElements.TextButton(1, 1, "Common Large") .. {
	InitCommand = function(self)
		self:xy(frameX + frameWidth - 350, frameY + 250 + spacingY * 2)
