...
local l = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		InitCommand = function(self)
			self:xy(frameWidth - offsetX - frameX + 260, frameHeight - headeroffY - 15 - offsetY):zoom(0.5):halign(1)
	...
	LoadFont("Common Normal") .. {
		Name = "Judge",
		InitCommand = function(self)
			self:xy(frameX + offsetX - 235,frameHeight - headeroffY - 65 - offsetY):zoom(0.45):halign(0.5):settext("")
		end,
		DisplayCommand = function(self)
	...
	LoadFont("Common Normal") .. {
		Name = "ChordCohesion",
		InitCommand = function(self)
			self:xy(frameX + offsetX - 235,frameHeight - headeroffY - 50 - offsetY):zoom(0.4):halign(0.5):settext("")
		end,
		DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	Name = "TheDootButton",
	InitCommand = function(self)
		self:xy(frameWidth - offsetX - frameX + 260, frameHeight - headeroffY - 35 - offsetY):zoom(0.525):halign(1):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	...
	InitCommand = function(self)
		self:xy(frameWidth - offsetX - frameX + 260, frameHeight - headeroffY - 49 - offsetY):zoom(0.425):halign(1):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	...
	InitCommand = function(self)
		self:xy(frameWidth - offsetX - frameX + 260, frameHeight - headeroffY - 63 - offsetY):zoom(0.425):halign(1):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	...
	InitCommand = function(self)
		self:xy(frameWidth - offsetX - frameX + 260, frameHeight - headeroffY - 77 - offsetY):zoom(0.425):halign(1):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
...
l[#l + 1] = UIElements.TextToolTip(1, 1, "Common Normal") .. {
	...
	InitCommand = function(self)
		self:xy(frameWidth - offsetX - frameX + 260, frameHeight - headeroffY - 91 - offsetY):zoom(0.425):halign(1):settext("")
		self:diffuse(getMainColor("positive"))
	end,
	DisplayCommand = function(self)
